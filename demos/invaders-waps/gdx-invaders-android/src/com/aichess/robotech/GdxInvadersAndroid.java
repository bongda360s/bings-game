...
public class GdxInvadersAndroid extends AndroidApplication implements UpdatePointsNotifier{
	//static{ 
...
//		}
	...
	@Override public void onCreate (Bundle savedInstanceState) {
        ...
        mainLayoutParams.gravity = Gravity.RIGHT;
      ...
      //waps ad
		...
		LinearLayout holder = new LinearLayout(GdxInvadersAndroid.this);		
		ImageView image = new ImageView(GdxInvadersAndroid.this);
		LinearLayout.LayoutParams imageParams = new LinearLayout.LayoutParams(getWindowManager().getDefaultDisplay().getWidth()-400,60);
		holder.addView(image,imageParams);
		
		LinearLayout.LayoutParams containerParams = new LinearLayout.LayoutParams(400,LayoutParams.WRAP_CONTENT);
		...
		case settingID:
			...
			*/
			...
			btnAward.setOnClickListener(new Button.OnClickListener(){
				...
				@Override
				public void onClick(View v) {
					AppConnect.getInstance(GdxInvadersAndroid.this).showOffers(GdxInvadersAndroid.this);					
				}});
...
//		}
	...
	private void getWapsPoints() {
		AppConnect.getInstance(GdxInvadersAndroid.this).getPoints(GdxInvadersAndroid.this);
	}
	@Override
	...
	public void getUpdatePoints(String arg0, int arg1) {
		...
		Settings.awardCount  = Settings.wapsValue/Settings.robotechValue;
		
		if(Settings.awardCount > 0){
			Ship.lives += Settings.awardCount;
			Settings.wapsValue -= Settings.awardCount * Settings.robotechValue;
			AppConnect.getInstance(GdxInvadersAndroid.this).spendPoints(Settings.awardCount * Settings.robotechValue, GdxInvadersAndroid.this);
		}
	}
