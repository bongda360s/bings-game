...
public class Settings {
    ...
    private static List<Fighting> fightings = new ArrayList<Fighting>();
	private static List<Fighting> netFightings = new ArrayList<Fighting>();
	...
	public static final int robotechValue = 50;
    ...
    public static void addFighting(Fighting fighting){
    	try{
    		if(fightings!=null && fighting!=null){
